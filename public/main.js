...
projects.push(new Project(
    'http://res.cloudinary.com/flyakite/image/upload/q_60/v1514414844/search_rifri5.png', {
        source: 'https://github.com/snorkleboy/FlyAKite',
        live: 'http://flyakite.artemkharshan.com'
    }, ['rgba(100,100,100,1)'],
    "FlyaKite",
...
projects.push(new Project(
    'http://res.cloudinary.com/flyakite/image/upload/q_60/v1515983798/tor-logo-large-89ac1c118b86d69953fff1ab31128550fcce9a74162e9b3fb7d0fc4bfd83e1ed_u2mbbn.png', {
        source: 'https://github.com/reidjs/onionup',
        live: 'http://onionup.artemkharshan.com'
    }, ['rgba(100,100,100,1)'],
    "Onionup",
...
//comprsion visuzlizer
projects.push(new Project(
    'http://res.cloudinary.com/flyakite/image/upload/c_scale,q_56,w_203/v1515907377/download_1_fl6gow_kltvt8.png', {
        source: 'https://github.com/snorkleboy/Compression-visualizer',
        live: 'https://imagereader.herokuapp.com'
    }, ['rgba(100,100,100,1)'],
...
projects.push(new Project(
    'http://res.cloudinary.com/flyakite/image/upload/v1522352789/logo_znrlin.png', {
        source: 'https://github.com/snorkleboy/TCPchat',
        live: 'http://chat.artemkharshan.com'
    }, ['rgba(100,100,100,1)'],
    "Tchat",
    '-WIP- A CLI and Browser Instant Chat App', ['Designed a custom server using Ruby TCP Sockets', 'Made a CLI instant chat app with Ruby Threads and TCP sockets', 'Will make a HTML WebSocket based single page app instant chat that I will hook up with the TCP chat. ']
));
//tfin
projects.push(new Project(
